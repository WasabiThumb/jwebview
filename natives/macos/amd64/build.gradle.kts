...
description = "Natives for JWebView (MacOS AMD64)"
...
mavenPublishing {
    ...
    signAllPublications()
    coordinates("${project.group}", "jwebview-natives-macos-amd64", "${project.version}")
    pom {
        name.set("JWebView Natives MacOS AMD64")
