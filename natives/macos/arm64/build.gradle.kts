...
description = "Natives for JWebView (MacOS ARM64)"
...
mavenPublishing {
    ...
    signAllPublications()
    coordinates("${project.group}", "jwebview-natives-macos-arm64", "${project.version}")
    pom {
        name.set("JWebView Natives MacOS ARM64")
